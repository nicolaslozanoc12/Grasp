 ...
 * @author nicol
 */
public class PersonalInscritoGUI extends javax.swing.JFrame {

    /**
     * Creates new form PaisGUI
     */
    public PersonalInscritoGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersonalInscritoGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PersonalInscritoGUI().setVisible(true);
            }
        });
    }
