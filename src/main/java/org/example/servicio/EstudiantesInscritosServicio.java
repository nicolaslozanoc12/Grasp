...
public class EstudiantesInscritosServicio {
    private final EstudiantesInscritosDAOImpl estudiantesInscritosDAO;

    public EstudiantesInscritosServicio(EstudiantesInscritosDAOImpl estudiantesInscritosDAO) {
